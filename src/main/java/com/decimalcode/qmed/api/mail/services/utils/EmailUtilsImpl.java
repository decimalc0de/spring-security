...
import static com.decimalcode.qmed.misc.ApiGeneralSettings.getFileNameWithoutExtension;

@Component
@SuppressWarnings({"unused", "FieldMayBeFinal"})
public class EmailUtilsImpl implements IEmailUtils {
    ...
    @Autowired
    public EmailUtilsImpl(JavaMailSender emailSender,
