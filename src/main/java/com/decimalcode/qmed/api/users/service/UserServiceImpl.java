...
import com.decimalcode.qmed.api._services.VerifyUserServiceImpl;
...
public class UserServiceImpl implements IUserService, UserDetailsService {
    ...
    private final VerifyUserServiceImpl verifyServiceImpl;
    ...
    public ApiResponse<UserEntity> signUp(UserEntity user) {
        ...
        */
         ...
         */
        return verifyServiceImpl.emailAccount(user);
    }
